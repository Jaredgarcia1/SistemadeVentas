...
namespace SistemaVentas
{
    public partial class mtnProducto : Form
    {
        ...
        private void cargarCombosSeleccion()
        {
            ...
            List<Categoria> oListaCategoria = CdCategoria.ObtenerCategoria();
        ...
        private void btnGuardarCambios_Click(object sender, EventArgs e)
        {
            ...
            if (modoEditar)
            {
                Respuesta = CdProducto.ModificarProducto(oProducto);
            ...
            else
            {
                ...
                Respuesta = CdProducto.RegistrarProducto(oProducto);
