...
namespace SistemaVentas
{
    public partial class frmRolPermiso : Form
    {
        ...
        {
            List<Rol> oListaRol = CdRol.ObtenerRol();
        ...
        private void CargarDatos(int IdRol)
        {
            ...
            List<Permisos> oListaPermisos = CdPermisos.ObtenerPermisos(IdRol);
        ...
        private void btnGuardarCambios_Click(object sender, EventArgs e)
        {
            if(dgvPermisos.Rows.Count > 0)
            {
                ...
                bool Respuesta = CdPermisos.ActualizarPermisos(Detalle_Permisos.ToString());
