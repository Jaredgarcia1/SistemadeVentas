...
namespace SistemaVentas
{
    public partial class MDIMaster : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Configuracion.oUsuario = CdUsuario.ObtenerDetalleUsuario(IdUsuario);


            //Configuracion.Usuario = CD_Usuario.ObtenerDetalleUsuario("Tienda", "Tienda123");
            ...
            ToolStripStatusLabel tslblData2 = new ToolStripStatusLabel(Configuracion.oUsuario.Rol.Descripcion);
            ...
            foreach (CapaModelo.Menu oMenu in Configuracion.oUsuario.ListaMenu)
            {
